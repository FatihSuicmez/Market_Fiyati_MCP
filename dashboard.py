...
# --- Yapılandırma Ayarları (Doğrudan Market Fiyatı Sunucusu için) ---
PRIVATE_KEY_FILE = "private_key.pem"
PUBLIC_KEY_FILE = "public_key.pem"
TOKENS_FILE = "tokens.json" 

# ISSUER: Token'ı kimin ürettiğini belirtir. Bu genellikle dashboard'un kendi adresidir.
ISSUER_URL = os.getenv("DASHBOARD_ISSUER_URL")

# AUDIENCE: Token'ın hangi sunucu için geçerli olduğunu belirtir.
# Bu, market_fiyati_mcp_server.py dosyasındaki AUDIENCE ile aynı olmalıdır.
...
<head>
    <meta charset="UTF-8">
    <title>Market Fiyatı MCP - Token Paneli</title>
    <style>
...
<body>
    <div class="container">
        <h1>Market Fiyatı MCP - Token Paneli</h1>
        
        <h2>Yeni Token Oluştur</h2>
        <form action="/generate" method="post">
            <label for="subject">Kullanıcı/İstemci Adı (örn: n8n_client):</label><br><br>
